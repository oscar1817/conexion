function consulta_general(){
    ...
    <td><button type='button' class="btn btn-info" onclick="location.href ='edit.html?variable1=${data.baul[i].id_baul}'"> <img src='img/editar.png' height ='30' width='30'/></button>
    <button type='button' class="btn btn-warning" onclick="eliminar(${data.baul[i].id_baul})"> <img src='img/eliminar.png' height ='30'width='30'/></button></tr>`
    }
...
document.getElementById("clave").value=data.baul.clave
 ...
 function modificar(){
   ...
   const visualizar = (response) => {
    ...
    Swal.fire("Mensaje", "Registro actualizado exitosamente", "success")
   }
   }